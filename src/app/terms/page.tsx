                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.section}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>유산균이 살아있는 최적의 0~4℃ 전용 오토바이 신속배송으로 하노이 현지 가정 및 식당으로 당일 직배송 출하됩니다.</li>
                        </ul>
                    </div>

                    {/* Section 6 */}
                    <div className={styles.section}>
                        <h2 className={styles.sectionHeading}>제6조 (상품 주문 및 오토바이 배송)</h2>
                        <p>
                            회사는 회원이 주문한 상품이 최상의 신선도를 유지할 수 있도록 0~4℃ 정밀 오토바이 신속배송을 통해 하노이 및 베트남 전역으로 배송을 실시합니다.
                        </p>
                    </div>
                    ...
                    <div className={styles.section}>
                        ...
                        <p>
                            하노이 내 한식당, 호텔, 기업체 급식 및 마트에 정기적으로 5kg 도매 포장 단위로 신선하게 오토바이로 납품합니다. 김치 및 신선 식품의 특성상 제품 포장이 훼손되었거나 단순 변심에 의한 반품은 제한될 수 있습니다. 단, 배송 중 파손, 변질, 제품 하자 등이 발생한 경우 상품 수령 후 24시간 이내에 고객센터로 접수해 주시면 100% 교환 또는 환불 처리해 드립니다.
                        </p>
                    </div>
